...
../../rvtoolchain2/bin/riscv64-unknown-elf-objcopy -j .init -j .text -j .bss -j .rodata -j .data --set-section-flags .bss=alloc,load,contents -O binary build/kernel build/kernel.bin
